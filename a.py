...
def _get_quicksort(n_arrs):
    ...
    quicksort_module = compile(quicksort_code, __file__, mode='exec')
    globals_dict = {}
    locals_dict = {}
    exec(quicksort_module, globals_dict, locals_dict)
    globals()['quicksort'] = locals_dict['quicksort']
...
if __name__ == "__main__":
    ...
    # s = 0
    # e = 5
    # stack = np.zeros(5, dtype=np.int64)
    # arr = np.array([5, 4, 3, 2, 1], dtype=np.int64)
    # quicksort(a, s, e, stack, arr)